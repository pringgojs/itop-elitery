...
class getSessionMessageControllerService extends Combodo_iTop_Portal_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.oiiXv_v'] ?? $container->load('get_ServiceLocator_OiiXvVService'))->withContext('Combodo\\iTop\\Portal\\Controller\\SessionMessageController', $container));
